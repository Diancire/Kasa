    ...
    return isOpen ?(
        <div className='collapse'>
            <div className='collapse_head' onClick={() => setIsOpen(false)}>
                ...
                <img src={vector_open} alt='flèche collapse' className='collapse_img'></img>
            </div>
            {isOpenTxt ? (
                <p className='collapse_texte' onClick={() => setIsOpenTxt(false)}>{texte}</p>
            ): (<p className='collapse_texte' onClick={() => setIsOpenTxt(true)}>{texte}</p>)}
        </div>
        ) : (
        <div className='collapse'>
            <div className='collapse_head' onClick={() => setIsOpen(true)}>
                <span className='collapse_title'>{title}</span>
                <img src={vector_close} alt='flèche collapse' className='collapse_img'></img>
            </div>
        </div>
