    ...
    return (
      <div className="lodging">
         <div className='lodging_info'>
            <div className="lodging_title">
               {description.title}
            </div>
            <div className='lodging_location'>
               {description.location}
            </div>
            <ul className='lodging_tags'>
               {description.tags.map((tagsNumber) => (
                  <li key={tagsNumber} className='lodging_tag'>{tagsNumber}</li>
               ))}
            </ul>
         </div>
         <div className='lodging_info lodging_info_right'>
            <div className='lodging_host'>
               <div className='lodging_host_name'>
            ...
            <div className='lodging_rating'>
               ...
               <img src={star_pink} alt='etoile rose' key={ratingElement} className='lodging_star'/> 
               : <img src={star_grey} alt='etoile grise' key={ratingElement} className='lodging_star'/>
               )}
            </div>
         </div>
      </div>
